...
window.Velo = __webpack_require__(9);
  ...
  var loadLinks = function loadLinks() {
    ...
    for (var i = 0; i < links.length; i++) {
      ...
      link.addEventListener('click', function (e) {
        ...
        Velo(this.parentNode, {
          scale: 1.1,
          opacity: 0
        }, {
          duration: 120,
          complete: function complete() {
            Velo(document.querySelectorAll('article,main,.site-header .tagline,.site-header h2,.site-header .post-date'), {
              scale: 1.1,
              opacity: 0
            }, {
              duration: 400,
