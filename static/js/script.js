...
window.Velo = __webpack_require__(/*! velocity-animate */ "./node_modules/velocity-animate/velocity.js");
var lastScrollTop = 0;
...
function scrollToTop(duration, callback) {
  ...
  Velo(document.getElementsByTagName('html'), "scroll", {
    duration: duration,
    offset: 0,
    mobileHA: false,
    complete: callback
...
window.addEventListener('load', dismissLoader = function dismissLoader() {
